...
export default function SignUpEmailOTPCard() {
  return (
    <>
      <h2 className="text-center text-2xl font-semibold text-primary">
        OTP Verification
      </h2>
      <p className="text-center text-sm w-full max-w-lg md:px-10 font-mulish mt-3 text-[#939393]">
      A 6-digit code is sent to your email. Kindly enter that 
      code here to continue further. Thanks
      </p>
