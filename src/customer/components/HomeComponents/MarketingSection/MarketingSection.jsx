        ...
        <div className="w-[85%] mx-auto mt-10 md:mt-16 grid grid-cols-1 gap-0 md:gap-8 lg:gap-0  lg:grid-cols-2 items-center">
          ...
          <div className="py-10 flex flex-col justify-center gap-2 md:ps-10 lg:pe-24">
            ...
            <p className="text-sm font-mulish mt-5">
              Target client groups with our unbeatable filtering tools to reach
              your top spenders, most loyal, lapsed clients and more
            </p>
            <p className="text-sm font-mulish mt-5">
              Surpise clients on their special day with a discount, turn
              newcomers into regulars and win back disengaged clients, all with
            </p>
