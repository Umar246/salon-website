...
const cardData = [
  ...
  },
  {
    ...
    description:
      "Payments, people, documentation, so you can focus on running your business.",
  },
  {
    icon: MdPayment,
    title: "Payment Processing",
    description:
      "Flexible payments solutions to meet the needs of your business.",
  },
  {
    icon: FaUserTie,
    title: "Clients",
    description:
      "Rely on us to help you stay busy and to protect yourself against no-shows.",
  },
  {
    icon: RiTeamFill,
    title: "Staff",
    description:
      "Keep tabs on your Staff members through powerful business insights.",
  },
  {
    icon: RiServiceFill,
    title: "Services",
        ...
        <div className="mt-10 md:mt-20 grid grid-cols-1 md:grid-cols-2 font-mulish lg:grid-cols-3 2xl:grid-cols-4 gap-8 md:gap-14">
          {cardData.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="animated-btn group rounded-2xl flex flex-col items-center justify-center hover:bg-primary space-y-2 px-10 py-8 transition-all duration-300"
                style={{ boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px" }}
              >
                <div className="bg-primary p-2 rounded-lg transition-all duration-300 group-hover:bg-secondary">
                  <Icon
                    className="text-neutral group-hover:text-primary"
                    size={26}
                  />
                </div>
